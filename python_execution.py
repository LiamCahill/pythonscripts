...
#PS to run .py script: "python filename.py"
#eventually, the program should
#1. check if gpg is installed on host
#if true: proceed
#if false: install via homebrew
#2. First, prompt user for path to file-to-be-encrypted
#Pass file through as argument for gpg command
